  ...
  return (
    <div className="shell">
      ...
      <div className="page-header" data-tour="shell.page-header">
        <div>
          <h1>{activeSection === 'today' ? 'Today' : activeSection === 'tasks' ? 'Tasks' : activeSection === 'projects' ? 'Task Manager' : activeSection === 'team' ? 'Team' : activeSection === 'reports' ? 'Reports' : activeSection === 'analytics' ? 'Analytics' : activeSection === 'settings' ? 'Settings & Automations' : 'Blocked Command Center'}</h1>
