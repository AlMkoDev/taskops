...
export function TasksWorkspace() {
  ...
  const currentTourModule: 'tasks' | 'projects' | 'team' | 'reports' | 'analytics' | 'settings' = activeSection === 'blocked' ? 'tasks' : activeSection;
